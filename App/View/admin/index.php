    ...
    <pre>This administration pannel let you do <strong>CRUD</strong> actions <small>(Create, Read, Update and Delete)</small> on different sections of the website.</pre>
    <div class="col-xs-12 col-sm-12 pannel">
        <h2 class="text-primary">Post pannel <small>activities and categories</small></h2>
        <div class="col-xs-6">
    ...
    <div class="col-xs-12 col-sm-6 pannel">
        <h2 class="text-warning">Testimony pannel</h2>
        <div class="col-xs-12">
    ...
    <div class="col-xs-12 col-sm-6 pull-right pannel">
        <h2 class="text-success">Page pannel</h2>
        <div class="col-xs-12">
...
<div class="col-xs-12 col-sm-6 pannel">
    <h2 class="text-danger">User pannel</h2>
    <div class="col-xs-12">
